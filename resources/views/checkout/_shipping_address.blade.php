<div id="shipping-address" v-show="!shipToBillingAddress">
    ...
    <div class="form-group row">
        ...
        <label class="col-form-label col-md-2">{{ __('İsim') }}</label>
        <div class="col-md-10">
    ...
    <div class="form-group row">
        <label class="col-form-label col-md-2">{{ __('Ülke') }}</label>
        <div class="col-md-10">
    ...
    <div class="form-group row">
        ...
        <label class="col-form-label col-md-2">{{ __('Adres') }}</label>
        <div class="col-md-10">
    ...
    <div class="form-group row">
        ...
        <label class="col-form-label col-md-2">{{ __('Posta Kodu') }}</label>
        <div class="col-md-4">
        ...
        <label class="col-form-label col-md-2">{{ __('Şehir') }}</label>
        <div class="col-md-4">
