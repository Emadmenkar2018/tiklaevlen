...
<div class="form-group">
    <div class="input-group">
        ...
        {{ Form::text('deneme', null, [
                'class' => 'form-control form-control-lg' . ($errors->has('deneme') ? ' is-invalid' : ''),
                'placeholder' => __('Deneme')
            ])
        }}
        @if ($errors->has('deneme'))
            <div class="invalid-tooltip">{{ $errors->first('deneme') }}</div>
        @endif
    </div>
</div>
