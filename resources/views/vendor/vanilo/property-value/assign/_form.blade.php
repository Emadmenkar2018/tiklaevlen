...
<div id="properties-assign-to-model-modal" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {!! Form::open([
                    'url'  => route('vanilo.web_property_value.sync', [$for, $forId]),
                    'method' => 'PUT'
                ])
            !!}

            <div class="modal-header">
                <h5 class="modal-title" id="properties-assign-to-model-modal">{{ __('Özellik Ekle') }}</h5>
            ...
            <div class="modal-body">
                ...
                <table class="table table-condensed table-striped">
                    ...
                    <tr v-for="(assignedProperty, id) in assignedProperties" :id="id">
                        ...
                        <td>
                            <select name="propertyValues[]" v-model="assignedProperty.value" @change="onPropertyValueChange($event, id)" class="form-control form-control-sm">
                                ...
                                <option value="+">[+] {{ __('Değer Ekle') }}</option>
                            </select>
                        </td>
                    ...
                    <tfoot>
                        <tr class="bg-success">
                            <th class="align-middle">{{ __('Kullanılmamış Özellikler') }}:</th>
                            <td>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-link" data-dismiss="modal">{{ __('Kapat') }}</button>
